...
export function formCard() {
  ...
  const fieldCardNumber = el(
    ".field-container.cardNumberWrapper",
  ...
  const validateBlock = el(
    ".validate-wrapper",
    el(".validate-button-wrapper", el("button#validate-button", "Validate")),
    el(".validate-result", el("h2#validate-result-text")),
  );
