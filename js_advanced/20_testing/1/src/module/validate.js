export const validationCardNumber = (str) => {
  ...
  return (
    cardNumberRegexp.test(str) ||
    cardNumberRegexpAmericanExpress.test(str) ||
    cardNumberRegexpDiners.test(str)
  );
};
...
export const validateFormMainFunc = (
  validateTextWrapper,
  validateIdText,
  inputsObject,
) => {
  ...
  if (
    ...
    validationExpiryDate(expirationdate.value)
  ) {
